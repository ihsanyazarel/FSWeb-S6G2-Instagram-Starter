...
const App = () => {
  ...
  useEffect(()=>{
    !aramaDegeri ? setGonderiler(sahteVeri) :
    setGonderiler(sahteVeri.filter((gonderi)=>{return gonderi.username.includes(aramaDegeri)}))
  }, [aramaDegeri])
  ...
  return (
    <div className='App'>
      <AramaÇubuğu aramaDegeri={aramaDegeri} setAramaDegeri={setAramaDegeri}/>
